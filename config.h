 ...
 */
static char *font = "Victor Mono SemiBold:size=14:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
    ...
    "Victor Mono Nerd Font:style=SemiBold:size=14:antialias=true:autohint=true",
};
...
static const char *colorname[] = {
  ...
  /* special colors */
  [256] = "#232326", /* background */
  [257] = "#a7aab0", /* foreground */
};
...
/*
 * Disable checking for `badweight` as it can mess up terminal colours.
 */
static unsigned int checkweight = 0;
